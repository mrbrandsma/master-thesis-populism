...
feature_dict['w/s'] = False
feature_dict['Depth'] = False
feature_dict['Leesindex A'] = False
feature_dict['flesch'] = False
feature_dict['flesch-douma'] = False
# Sentiment analysis
feature_dict['sentiment'] = False
...
list_of_topic_words = ['islam', 'kartel', 'islamitisch', 'asielzoeker', 'gelukzoeker', 'lockdown', 'ondernemer'
                       ...
                       'coronawet', 'oorlog', 'huurder', 'wooncrisis', 'minimumloon', 'kernenergie', 'multinational', 'horeca', 'islam', 'kartel', 'islamitisch', 'asielzoeker', 'gelukzoeker', 'lockdown', 
                       'immigratie', 'toeslagenschandaal', 'klimaatakkoord', 'zorgverlener', 'aow', 
                       'kringlooplandbouw', 'klimaatcrisis', 'duurzaam', 'abortus', 'klimaatverandering', 
                       'progressief', 'uitstoot', 'groen', 'green', 'europees', 'leraar', 'student', 'klimaat', 'schoon', 
                       'vluchteling', 'grens', 'koopkracht', 'groninger', 'natuur', 'onderwijs', 'permanent', 'permanente', 
                       'coronawet', 'oorlog', 'minimumloon', 'huur', 'minimum', 'loon','minimumlonen', 'ondernemer', 'werkrdruk']
data_specific_words = ['ha', 'hoi', 'hi', 'party-kamerlid', 'partykamerlid', 'inside', '!', '#', '%', '&', "'", '(', ')', '+', ',', '-', '.', '...', '1', '1/2', '10', '100', 
                       ...
                       'socialer', 'eerlijker', 'sociaal', 'eerlijk', 'leiderschap', 'studio', 'uitzending', 'vd', 'nl', 'oa', 'app',
                       '️', '🇪', '🇺', '🌈', '🌍', '🌹', '🍀', '🍅', '🎉', '🎥', '🏡', '🏼', '👀', '👇', '👉', 
                       '👍', '👩', '💙', '💚', '💪', '📺', '📻', '🔥', '🔴', '🗳', '😉', '🙌', '🤯', '🧡']
